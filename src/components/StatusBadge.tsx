...
export const StatusBadge: React.FC<{ status: MOAStatus; small?: boolean }> = ({ status, small }) => {
  ...
  return (
    <span className={`gold-badge ${colors.bg} ${colors.text} ${colors.border} ${small ? 'text-xs' : ''}`}>
